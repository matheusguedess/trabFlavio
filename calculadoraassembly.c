...
int soma(void)
{
    __asm("movl _num1, %ebx ") ;    // Mover o que está na variavel num1 para o registrador b
    __asm("movl _num2, %eax") ;     // Mover o que está na variavel num2 para o registrador a
...
float div(void)
{
    __asm("movl _num1, %eax ") ;    // Mover o que está na variavel num1 para o registrador a
    __asm("movl _num2, %ebx") ;     // Mover o que está na variavel num2 para o registrador b
    __asm("idivl %ebx");
    __asm("movl %eax, _r") ;        // Mover o que está no registrador a para a variavel r
    return r;                       // retornar o q está na variavel r
}
